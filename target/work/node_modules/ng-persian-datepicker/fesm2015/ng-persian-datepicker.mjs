...
class NgPersianDatepickerComponent {
    ...
    set _formControlDirective(value) {
        this.setFormControl(value === null || value === void 0 ? void 0 : value.control);
    }
    ...
    ngOnDestroy() {
        var _a;
        (_a = this.formControlValueChanges) === null || _a === void 0 ? void 0 : _a.unsubscribe();
        if (this.input) {
    ...
    setFormControl(value) {
        ...
        if (!this.dateValue) {
            this.setDateInitValue((_a = this.formControl) === null || _a === void 0 ? void 0 : _a.value);
            this.setSelectedDate((_b = this.formControl) === null || _b === void 0 ? void 0 : _b.value);
            this.setViewDate();
            this.setTime();
            this.setFormControlValue();
        }
        (_c = this.formControlValueChanges) === null || _c === void 0 ? void 0 : _c.unsubscribe();
        this.formControlValueChanges = (_f = (_e = (_d = this.formControl) === null || _d === void 0 ? void 0 : _d.valueChanges) === null || _e === void 0 ? void 0 : _e.pipe(filter((date) => !!date && this.valueOfDate(date) !== this.dateValue))) === null || _f === void 0 ? void 0 : _f.subscribe({
            next: (value) => {
    ...
    setFormControlValue() {
        ...
        if (this.dateValue) {
            (_a = this.formControl) === null || _a === void 0 ? void 0 : _a.setValue(moment(this.dateValue).format(this.dateFormat));
        }
    }
    setShowOnInputFocus() {
